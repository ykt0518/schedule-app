    ...
    <div className='w-full h-screen flex self-center place-content-center place-items-center'>
      {user ? (
        ...
        <div className='w-96 text-gray-600 space-y-5 px-4 py-8 shadow-xl border rounded-xl'>
          <h3 className='text-gray-800 text-xl text-center font-semibold sm:text-2xl'>ログイン</h3>
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <button type="submit" className='w-full px-4 py-2 text-white font-medium rounded-lg bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'>ログイン</button>
          </form>
          <p className="text-center text-sm">アカウントを持っていない方は <Link to={`/signup/`} className='hover:text-blue-700 transition duration-300'>こちら</Link></p>
